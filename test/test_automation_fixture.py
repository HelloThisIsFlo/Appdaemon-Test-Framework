...
class TestAutomationFixture:
    ...
    def test_automation_was_initialized_with_default_initialize(self, testdir):
        testdir.makepyfile(
            """
            from appdaemon.plugins.hass.hassapi import Hass
            from appdaemontestframework import automation_fixture
    ...
    def test_automation_was_initialized_with_initialize_set_True(self, testdir):
        testdir.makepyfile(
            """
            from appdaemon.plugins.hass.hassapi import Hass
            from appdaemontestframework import automation_fixture
            ...
            @automation_fixture(MockAutomation, initialize=True)
            def mock_automation():
                pass
    ...
    def test_automation_was_not_initialized_with_initialize_set_False(self, testdir):
        testdir.makepyfile(
            ...
            def test_was_initialized(mock_automation):
                assert getattr(mock_automation, 'was_initialized', False) == False
        """)
