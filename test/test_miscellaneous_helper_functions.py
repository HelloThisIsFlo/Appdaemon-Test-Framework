...
def test_entity_exists_true(given_that, with_miscellaneous_helper_functions, hass_mock):
...
def test_entity_exists_false(given_that, with_miscellaneous_helper_functions, hass_mock):
