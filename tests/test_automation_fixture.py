...
class MockAutomation(Hass):
    def __init__(
        ...
        super().__init__(
            ad, name, logger, error, args, config, app_config, global_vars
        )
...
def expected_error_regex_was_found_in_stdout_lines(
...
class TestAutomationFixture:
    ...
    def test_calls_to_appdaemon_are_cleared_before_entering_test(
        self,
        testdir,
    ):
    ...
    def test_name_attribute_of_hass_object_set_to_automation_class_name(
        ...
        def test_name_attribute_hass_object_set_to_automation_class_name(
            mock_automation
        ):
    ...
    class TestInvalidAutomation:
        ...
        def assert_automation_class_fails(self, testdir):
            def wrapper(automation_class_src, expected_error_regex):
                ...
                if not expected_error_regex_was_found_in_stdout_lines(
                    ...
                    pytest.fail(
                        "Couldn't fine line matching error:"
                        f" '{expected_error_regex}'"
                    )
        ...
        def test_automation_has_no_initialize_function(
            ...
            assert_automation_class_fails(
                ...
                expected_error_regex=(
                    r"AutomationFixtureError: 'MockAutomation' .* no "
        ...
        def test_initialize_function_has_arguments_other_than_self(
            ...
            assert_automation_class_fails(
                automation_class_src="""
                    ...
                    """,
                expected_error_regex=(
                    r"AutomationFixtureError: 'MockAutomation'.*"
        ...
        def test___init___was_overridden(self, assert_automation_class_fails):
            assert_automation_class_fails(
                ...
                """,
                expected_error_regex=(
                    r"AutomationFixtureError: 'MockAutomation'.*should not"
                    r" override '__init__'"
                ),
            )
        ...
        def test_not_a_subclass_of_Hass(self, assert_automation_class_fails):
            assert_automation_class_fails(
                ...
                """,
                expected_error_regex=(
                    r"AutomationFixtureError: 'MockAutomation'.*should be a"
                    r" subclass of 'Hass'"
                ),
            )
    ...
    class TestWithArgs:
        def test_automation_is_injected_with_args(self, testdir):
            testdir.makepyfile(
                ...
                def test_automation_was_injected_with_args(
                    mock_automation_with_args
                ):
