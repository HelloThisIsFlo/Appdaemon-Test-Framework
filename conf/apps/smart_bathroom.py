...
class SmartBathroom(hass.Hass):
    def initialize(self):
        ...
        self.listen_event(self._new_motion_bathroom, 'motion', entity_id=ID['bathroom']['motion_sensor'])
        self.listen_event(self._new_motion_kitchen, 'motion', entity_id=ID['kitchen']['motion_sensor'])
